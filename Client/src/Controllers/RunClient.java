...
public class RunClient {
    ...
    public static void addDataToTableUser(ArrayList<User> listUser) {
        ...
        Object[] columns = {"ID", "Tên tài khoản", "Email", "Mật khẩu", "Địa chỉ", "Số điện thoại", "Ngày sinh", "CCCD", "Vai trò"};
    ...
    public static void addDataToTableVehicle(ArrayList<Vehicle> listVehicle) {
        ...
        Object[] columns = {"ID", "Tên phương tiện", "Màu", "Kiểu phương tiện", "Ngày sản xuất", "Số chỗ ngồi", "Phân khối", "Hãng"};
    ...
    public static void addDataToTableManageVehicle(ArrayList<ManageVehicle> manageVehicles) {
        ...
        Object columns[] = {"ID", "Tên người đăng ký", "Tên đăng ký", "Tên phương tiện", "Ngày đăng ký", "Biển số xe", "Số máy", "Số khung"};
